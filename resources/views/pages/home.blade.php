        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="row">
              ...
              <div class="col-sm-2">@lang('issue.project')</div>
              <div class="col-sm-1">@lang('issue.status')</div>
              <div class="col-sm-1">@lang('issue.type')</div>
              <div class="col-sm-1">@lang('issue.title')</div>
              <div class="col-sm-1">@lang('issue.assigned')</div>
              <div class="col-sm-3">@lang('issue.progress')</div>
            </div>
          </div>
        </div>
                           ...
                           <div class="row">
                            @foreach($issue->tracks as $track)
                              ...
                              @if (auth()->check() && $issue->status_id != 3 && $issue->users->id == auth()->user()->id )
                                    <div id="s{{ $track->id }}" class="panel-collapse collapse col-sm-12">
                                      <div class="row">
